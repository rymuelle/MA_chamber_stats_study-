...
class WheelSectorHistograms:
	def __init__(self, name, chamber_class, ref_chambers, ref_lumi):
		...
		for wheel in range(5):
					...
					for station in range(4):
						self.TH2F_sector_phix[wheel].append( r.TH2F("{}_TH2F_sector_phix_{}_{}".format(self.name, wheel-2,station+1),"#phi x wheel {} station {}".format(wheel-2,station+1), 100, 0, ref_lumi*2, 100, -.02,.02 ) )
						self.TH2F_sector_phiy[wheel].append( r.TH2F("{}_TH2F_sector_phiy_{}_{}".format(self.name, wheel-2,station+1),"#phi ywheel {} station {}".format(wheel-2,station+1), 100, 0, ref_lumi*2, 100, -.02,.02 ) )
						self.TH2F_sector_phiz[wheel].append( r.TH2F("{}_TH2F_sector_phiz_{}_{}".format(self.name, wheel-2,station+1),"#phi zwheel {} station {}".format(wheel-2,station+1), 100, 0, ref_lumi*2, 100, -.02,.02 ) )
		...
		for count, chamber in enumerate(chamber_class.chambers):
			...
			self.TH2F_sector_phix[chamber.wheel+2][chamber.station-1].Fill(eqv_lumi, float(chamber.phix))
			self.TH2F_sector_phiy[chamber.wheel+2][chamber.station-1].Fill(eqv_lumi, float(chamber.phiy))
			self.TH2F_sector_phiz[chamber.wheel+2][chamber.station-1].Fill(eqv_lumi, float(chamber.phiz))
